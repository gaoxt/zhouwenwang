                  ...
                  >
                    ...
                    <div style={{ margin: '15px' }}>
                      <motion.button 
                        ...
                        whileHover={!analyzing && selectedMaster ? { scale: 1.02 } : {}}
                        whileTap={!analyzing && selectedMaster ? { scale: 0.98 } : {}}
                      >
                        {analyzing ? (
                          <span 
